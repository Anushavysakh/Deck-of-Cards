package com.oopsprograms.bridglabz;
...
public class DeckofCardsExtend {
	...
	public static void main(String[] args) {
		...
		DeckofCardsExtend obj = new DeckofCardsExtend();	//	class object
		obj.start();	//	starts queueing
		obj.dequeuePlayers();	//	dequeues players
	}
